...
export default class ferrousNetwork extends React.Component<FerrousNetworkProps, FerrousNetworkState> {
    pane: HTMLElement | null | undefined;
    ferrous: HTMLElement | null | undefined;
    ...
    constructor(props: FerrousNetworkProps) {
        super(props);
    ...
    render() {
        ...
        return (
            <>
                <div
                    className="pane ferrous-network"
                    ref={(e) => {
                        this.pane = e;
                    }}
                >
                    <h1 className="heading neon">ferrous network</h1>
                    <div className="ferrous-network-grid">
                        <div
                            className="ferrous-network-left"
                            ref={(e) => {
                                this.leftTable = e;
                            }}
                        >
                        ...
                        <div
                            className="ferrous-network-mid"
                            ref={(e) => {
                                this.ferrous = e;
                            }}
                        >
                            <svg
                                className="neon ferrous-svg"
                                viewBox="0 0 128 128"
                        ...
                        <div
                            className="ferrous-network-right"
                            ref={(e) => {
                                this.rightTable = e;
                            }}
                        >
                        ...
                        <div className="ferrous-network-add">
                            <div
                                onClick={() => {
                    ...
                    <svg className="neon ferrous-network-data">
                ...
                >
                    <form
                        ...
                        className="popup-content pane ferrous-network-create"
                    >
