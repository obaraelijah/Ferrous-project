...
export default function AttacksIcon(params: AttacksParams) {
    ...
    return (
        ...
        >
            ...
            <path
                ...
                className={
                    activeAttackCategory === "services"
                        ? "ferrous-attacks-hex-box-selected ferrous-attacks-hex"
                        : "ferrous-attacks-hex"
                }
            ...
            <path
                ...
                className={
                    activeAttack === "service_detection"
                        ? "ferrous-attacks-hex-selected ferrous-attacks-hex ferrous-attacks-clickable"
                        : "ferrous-attacks-hex ferrous-attacks-clickable"
                }
            ...
            <path
                d="m81.966 81.46-40.05 23.324L1.694 81.763l-.175-46.346 40.049-23.324L81.79 35.114Z"
                className={"ferrous-attacks-hex-unavailable ferrous-attacks-hex"}
            ...
            <path
                ...
                className={
                    activeAttack === "bruteforce_subdomains"
                        ? "ferrous-attacks-hex-selected ferrous-attacks-clickable ferrous-attacks-hex"
                        : "ferrous-attacks-hex ferrous-attacks-clickable"
                }
            ...
            <path
                d="m81.966 81.46-40.05 23.324L1.694 81.763l-.175-46.346 40.049-23.324L81.79 35.114Z"
                className={"ferrous-attacks-hex ferrous-attacks-hex-unavailable"}
                transform="matrix(.46387 0 0 .46387 104.294 100.346)"
            />
            <text xmlSpace="preserve" x={71.5} y={58} className={"ferrous-attacks-hex-box-text"}>
                {"Ports"}
            </text>
            <text xmlSpace="preserve" x={66} y={130} className={"ferrous-attacks-hex-box-text"}>
                {"Domains"}
            </text>
            <text xmlSpace="preserve" x={108.5} y={58} className={"ferrous-attacks-hex-box-text"}>
                {"Services"}
            </text>
            <text xmlSpace="preserve" x={135} y={94} className={"ferrous-attacks-hex-box-text"}>
                {"Other"}
            </text>
            <text xmlSpace="preserve" x={49.5} y={94} className={"ferrous-attacks-hex-box-text"}>
                {"Hosts"}
            </text>
            <text xmlSpace="preserve" x={59.5} y={155.5} className={"ferrous-attacks-hex-text"}>
                {"BSd"}
            </text>
            <text xmlSpace="preserve" x={51.5} y={173} className={"ferrous-attacks-hex-text"}>
                {"CT"}
            </text>
            <text xmlSpace="preserve" x={171.25} y={94} className={"ferrous-attacks-hex-text"}>
                {"Dh"}
            </text>
            <text xmlSpace="preserve" x={21.5} y={94} className={"ferrous-attacks-hex-text"}>
                {"WHO"}
            </text>
            <text xmlSpace="preserve" x={59} y={31} className={"ferrous-attacks-hex-text"}>
                {"PsT"}
            </text>
            <text xmlSpace="preserve" x={133} y={31} className={"ferrous-attacks-hex-text"}>
                {"SvD"}
            </text>
            <text xmlSpace="preserve" x={5} y={94} className={"ferrous-attacks-hex-text"}>
                {"HA"}
            </text>
        </svg>
    );
